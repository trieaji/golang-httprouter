...
func TestRouterPatternNamedParameter(t *testing.T) {
	...
	request := httptest.NewRequest("GET", "http://localhost:4000/products/1/items/1",nil) //nil itu body
...
func TestRouterPatternCatchAllParameter(t *testing.T) {
	...
	request := httptest.NewRequest("GET", "http://localhost:4000/images/small/profile.png",nil) //nil itu body
	recorder := httptest.NewRecorder()
